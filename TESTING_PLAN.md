...
- [ ] Создать `TestKernel` в `tests/Fixtures/`
- [ ] Создать базовый `KernelTestCase` в `tests/Functional/`
- [ ] Создать тестовые конфигурации в `tests/Fixtures/config/`
- [ ] Обновить `phpunit.xml` для работы с TestKernel

### Этап 2: Расширение Unit тестов

- [ ] Добавить `OctowireTokenTest.php`
- [ ] Добавить `OctowireUserTest.php`
- [ ] Добавить `AuthClientFactoryTest.php`
- [ ] Расширить `TokenValidatorTest.php`
- [ ] Расширить `OctowireTokenAuthenticatorTest.php`

### Этап 3: Functional тесты

- [ ] Создать `BundleConfigurationTest.php`
- [ ] Обновить `SecurityIntegrationTest.php` для Kernel тестов
- [ ] Создать `AuthenticatorIntegrationTest.php`
- [ ] Протестировать все сценарии аутентификации

### Этап 4: Интеграционные тесты (опционально)

- [ ] Настроить тестовое окружение с Auth Service
- [ ] Создать интеграционные тесты с реальным сервисом
- [ ] Протестировать производительность

## ✅ Критерии готовности

- [ ] Все Unit тесты проходят (> 80% покрытие)
- [ ] Все Functional тесты проходят
- [ ] Bundle корректно работает в тестовом Symfony приложении
- [ ] Security integration работает полностью
